  ...
  return (
    <div className="flex justify-between border-b-2 py-2">
      <div className="flex flex-col justify-center items-start gap-2 w-1/2">
        <h1 className="inline-flex max-w-[75%] text-md font-semibold">
          {props.name}
        </h1>
        <p className="text-sm text-foreground max-w-[200px] whitespace-nowrap text-ellipsis overflow-hidden">
          {props.description}
        </p>
      </div>
