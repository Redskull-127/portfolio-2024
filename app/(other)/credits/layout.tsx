...
export const metadata: Metadata = {
  title: `Credits | Meer Tarbani`,
  description: `Thanks to all the people who helped me in making this website.`,
  keywords:
...
export default function EventsLayout({ children }: Children) {
  return children;
}
